...
<div class="container py-5">
    <h2 class="text-center mb-4 text-dark">Tambah Program Studi</h2>

    <form action="{{ route('prodi.store') }}" method="POST" class="p-4 bg-white shadow rounded">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_prodi" id="nama_prodi"
                   ...
                   value="{{ old('nama_prodi') }}" pattern="[A-Za-z\s]+" required>
