...
<div class="container py-5">
    <h2 class="text-center mb-4 text-dark">Edit Fakultas</h2>

    <form action="{{ route('fakultas.update', $fakultas->id) }}" method="POST" class="p-4 bg-white shadow rounded">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_fakultas" id="nama_fakultas"
                   ...
                   value="{{ old('nama_fakultas', $fakultas->nama_fakultas) }}" pattern="[A-Za-z\s]+" required>
